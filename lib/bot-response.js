...
//   if (this.botMessage === 'I am a robot.') {this.checkForQuestion(); };
//   if (this.userMessage === 'I am a robot.') {this.checkForMessageAboutTuring();};
// };
...
BotResponse.prototype.checkForSwearWords = function() {
  ...
  var userMessageArray = caseSensitiveUserMessage.split(' ');
  ...
  for (var i=0; i<swearWords.length; i++) {
    if (userMessageArray.indexOf(swearWords[i]) > -1) {
...
BotResponse.prototype.checkForQuestion= function() {
  var userMessageArray = this.userMessage.split('');
...
BotResponse.prototype.checkForAggressiveStatement = function() {
  ...
  // if (this.userMessage === checkedForCapsLock) { this.botMessageContent = aggressiveStatementResponses[Math.floor((Math.random()*aggressiveStatementResponses.length))]}
  for (var i=0; i<aggressiveStatementResponses.length; i++) {
    if (this.userMessage === checkedForCapsLock || userMessageArray.indexOf('!') > -1) {
  ...
  BotResponse.prototype.checkForMessageAboutAdam = function() {
    ...
    for (var i=0; i<names.length; i++) {
      if (userMessageArray.indexOf(names[i]) > -1) {
  ...
  BotResponse.prototype.checkForMessageAboutGirlCasey = function() {
    var caseSensitiveUserMessage = this.userMessage.toLowerCase();
    var names = ['girl casey', 'cross', 'girlcasey']
  ...
  BotResponse.prototype.checkForMessageAboutBoyCasey = function() {
    var caseSensitiveUserMessage = this.userMessage.toLowerCase();
    var names = ['boy casey', 'metz', 'boycasey']
